    ...
    <div class="formularioUsuario bg-dark">
		<div class="container align-self-center p-6">
			...
			<form action="UsuarioController" method="post">
				<input type="hidden" name="opcion" value="guardarUsuario">
				...
				<div class="form-row mb-2">
					<div class="form-group col-md-6">
						...
						<input type="text" class="form-control" placeholder="Tu ciudad" name="text_ciudad">
					</div>
					<div class="form-group col-md-6">
						<label class="font-weight-bold">Dirección <span class="text-danger">*</span></label>
						<input type="text" class="form-control" placeholder="Tu dirección" name="text_direccion">
					</div>
				</div>
				<div class="form-row mb-2">
					...
					<div class="form-group col-md-4">
                        ...
                        <div class="form-row mb-2">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" placeholder="Nombre usuario" name="text_usuario">
                            </div>
                            <div class="form-group col-md-6">
                                <label class="font-weight-bold">Contraseña <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" placeholder="Contraseña" name="text_clave">
                            </div>
                        </div>
